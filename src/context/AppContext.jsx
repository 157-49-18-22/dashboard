        ...
        return prev.map((q) => {
          ...
          return { 
            ...
            ...(query ? {
              ...
              assignedTo: query.assignedTo !== undefined ? query.assignedTo : q.assignedTo,
              assignedToGroup: query.assignedToGroup !== undefined ? query.assignedToGroup : q.assignedToGroup,
              status: query.status ?? q.status,
              acceptedAt: query.acceptedAt !== undefined ? query.acceptedAt : q.acceptedAt,
            } : {}),
            unread: (q.unread || 0) + 1, 
            message: msgText,
